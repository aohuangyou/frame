<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/Users/xinjiashuodemac/workspace/my/frame/public/../application/admin/view/group/create.html";i:1562725496;}*/ ?>
...
<body>
  <div class="layui-fluid">
    <div class="layui-card">
      <div class="layui-card-header">创建用户组</div>
        ...
        <form class="layui-form" action="" lay-filter="component-form-group" id="myform">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="group_name" autocomplete="off" placeholder="请输入用户名" class="layui-input">
            </div>
          </div>
            ...
            <div class="layui-input-block">
              <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menus): $mod = ($i % 2 );++$i;?>
                <?php echo $menus['title']; if(is_array($menus['items']) || $menus['items'] instanceof \think\Collection || $menus['items'] instanceof \think\Paginator): $i = 0; $__LIST__ = $menus['items'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                  <input type="checkbox" name="group_purview[<?php echo $item['menu_id']; ?>]" title="<?php echo $item['menu_name']; ?>" lay-filter="menusbat">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="radio" name="group_status" value="1" title="正常" checked="">
              <input type="radio" name="group_status" value="0" title="禁用">
            </div>
          </div>
